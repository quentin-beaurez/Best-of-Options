...
\begin{align*}
  ...
  \intertext{Notons encore une fois que $S_t^i = \exp\left(\log (\frac{S_T^i}{s_0^i})\right)$ et que $\log\left(\frac{S^i_T}{s^i_0}\right) \sim \N\left((r- \frac{\sigma_i^2}{2})\,T , \sigma_i^2 \,T\right)$. Donc on a :}
  P^1 &=  e^{-rT} \E \left(\max\left(s_0^1 \exp\left((r- \frac{\sigma_1^2}{2})\,T + \sigma_1\sqrt{T} Y\right), s_0^2 \exp\left((r- \frac{\sigma_2^2}{2})\,T + \sigma_2\sqrt{T} Y\right) \right)\right)\\
  &\qquad- e^{-rT}K,
